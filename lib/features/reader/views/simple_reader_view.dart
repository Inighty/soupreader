...
part 'simple_reader_view_menu_actions.dart';
part 'simple_reader_view_source_switch.dart';
part 'simple_reader_view_bookmark_catalog.dart';
part 'simple_reader_view_private_classes.dart';
...
class _SimpleReaderViewState extends State<SimpleReaderView>
  ...
  Future<void> _showPageKeyConfigDialog(StateSetter setPopupState) async {
    ...
    final result = await showCupertinoBottomDialog<Map<String, List<int>>?>(
      context: context,
      builder: (dialogContext) => CupertinoAlertDialog(
