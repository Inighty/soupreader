...
import 'dict_rule_import_candidate_tile.dart';

/// 弹出待导入候选规则的多选面板。
Future<Set<int>?> showDictRuleImportSelectionSheet({
                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return DictRuleImportCandidateTile(
                        candidate: candidate,
                        selected: selected,
                        onTap: () {
                          setDialogState(() {
...
/// 弹出「网络导入」输入面板，含历史记录。
Future<String?> showDictRuleOnlineImportInputSheet({
  required BuildContext context,
...
/// 通用提示对话框。
Future<void> showDictRuleMessageDialog({
  required BuildContext context,
...
Future<void> runDictRuleImportingTask({
  required BuildContext context,
...
/// 「导出成功」展示路径并支持复制。
Future<void> showDictRuleExportPathDialog({
  required BuildContext context,
...
/// 加载 markdown 帮助并展示。
Future<void> showDictRuleHelpDialog(BuildContext context) async {
  try {
    final markdownText =
...
String formatDictRuleImportError(Object error) {
