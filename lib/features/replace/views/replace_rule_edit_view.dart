...
class _ReplaceRuleEditViewState extends State<ReplaceRuleEditView> {
  ...
  void initState() {
    ...
    _timeoutCtrl =
        TextEditingController(text: _rule.timeoutMillisecond.toString());
  ...
  void _syncRuleFromFields() {
    ...
    setState(() {
      _rule = _rule.copyWith(
        ...
        timeoutMillisecond:
            tryInt(_timeoutCtrl.text) ?? _rule.timeoutMillisecond,
            ...
            children: [
              CupertinoListTile.notched(
                ...
                trailing: CupertinoSwitch(
                  ...
                  onChanged: (v) =>
                      setState(() => _rule = _rule.copyWith(isEnabled: v)),
                ),
              ),
              _TextFieldTile(
                title: '名称',
            ...
            children: [
              CupertinoListTile.notched(
                ...
                trailing: CupertinoSwitch(
                  value: _rule.isRegex,
                  onChanged: (v) =>
                      setState(() => _rule = _rule.copyWith(isRegex: v)),
                ),
              ),
              _TextFieldTile(
                title: '匹配（pattern）',
            ...
            children: [
              ...
              CupertinoListTile.notched(
                ...
                trailing: CupertinoSwitch(
                  ...
                  onChanged: (v) =>
                      setState(() => _rule = _rule.copyWith(scopeTitle: v)),
                ),
              ),
              CupertinoListTile.notched(
                ...
                trailing: CupertinoSwitch(
                  ...
                  onChanged: (v) =>
                      setState(() => _rule = _rule.copyWith(scopeContent: v)),
                ),
              ),
            ],
          ),
